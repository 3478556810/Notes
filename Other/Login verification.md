...
![image-20230409101851967](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409101851967.png?x-os)

打开浏览器完成前后端联调操作：利用开发者工具，抓取一下网络请求

![](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409102149341.png?x-os)
...
![image-20230409102314191](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409102314191.png?x-os)
...
![image-20230409102416688](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409102416688.png?x-os)
...
![image-20230112120955145](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230112120955145.png?x-os) 
...
![image-20230106222559935](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230106222559935.png?x-os)
...
![image-20230107084730393](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230107084730393.png?x-os)
...
![image-20230409110858673](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409110858673.png?x-os)

通过控制台日志的输出，大家发现AbcFilter先执行DemoFilter后执行，这是为什么呢？

其实是和过滤器的类名有关系。以注解方式配置的Filter过滤器，它的执行优先级是按时过滤器类名字符串的自动排序确定的，类名排名越靠前，优先级越高。
...
![image-20230107095010089](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230107095010089.png?x-os)
...
![image-20230112122130564](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230112122130564.png?x-os) 
...
![image-20230409133411188](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409133411188.png?x-os)

- 测试2：先进行登录操作，再访问部门管理页面

  登录校验成功之后，可以正常访问相关业务操作页面

![image-20230409133621734](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409133621734.png?x-os)
...
![image-20230409135929346](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409135929346.png?x-os)
...
![image-20230107112136151](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230107112136151.png?x-os)
...
![image-20230409141007182](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409141007182.png?x-os)
...
![image-20230409141927722](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409141927722.png?x-os)
...
![image-20230107121909087](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230107121909087.png?x-os)
...
![image-20230107122904214](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230107122904214.png?x-os)
...
![image-20230409143202728](https://typora-picsbed-new.oss-cn-shanghai.aliyuncs.com/typora/image-20230409143202728.png?x-os)
